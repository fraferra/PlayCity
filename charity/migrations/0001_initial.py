...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'charity_organization', (
        ...
        db.send_create_signal(u'charity', ['Organization'])

        # Adding model 'Event'
        db.create_table(u'charity_event', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('challenge_event', self.gf('django.db.models.fields.CharField')(default='Event', max_length=50)),
            ...
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('organizer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['charity.Organization'])),
        ))
        db.send_create_signal(u'charity', ['Event'])

        # Adding M2M table for field participants on 'Event'
        m2m_table_name = db.shorten_name(u'charity_event_participants')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('event', models.ForeignKey(orm[u'charity.event'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'charity_organization')

        # Deleting model 'Event'
        db.delete_table(u'charity_event')

        # Removing M2M table for field participants on 'Event'
        db.delete_table(db.shorten_name(u'charity_event_participants'))
