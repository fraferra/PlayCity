...
SECRET_KEY = '6qbaw_&!la_(3x^!$_q8kq%kh@q_ws3^sm(e&n4!bb0r!vr&6y'
...
WSGI_APPLICATION = 'play_palo_alto.wsgi.application'
...
SUBDOMAIN_URLCONFS = {
    None:  'play_palo_alto.urls',  # no subdomain, e.g. ``example.com``
    #'city': 'myproject.urls',
