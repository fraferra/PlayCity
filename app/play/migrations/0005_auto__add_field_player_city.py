...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.city'
        db.add_column(u'play_player', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='city', null=True, to=orm['city.City']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.city'
        db.delete_column(u'play_player', 'city_id')
